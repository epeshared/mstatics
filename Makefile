...
libmstatics.so: $(SRC)/mstatics.c $(SRC)/$(HEADERS)
	g++ -std=c++11 -fPIC -g -ggdb -O0 -shared -Wl,-z,defs,--as-needed -I/usr/include/ -I./include -I./  $(SRC)/mstatics.c -lpthread  -ldl -ldw -L/usr/lib64/libiberty.a  -o $(LIB)/libmstatics.so  -export-dynamic -ldl 
